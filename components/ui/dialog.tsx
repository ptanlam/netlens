...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-[1.25rem] border-t border-border bg-pane p-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
